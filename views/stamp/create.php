...
<form class="formulaire-ajouter" method="POST">
    <div class="formulaire-ajouter__field">
        ...
        <input type="text" id="name" name="name" class="formulaire-ajouter__input" required>
    </div>

    <div class="formulaire-ajouter__field">
        <label for="dateCreated" class="formulaire-ajouter__label">Date de création:</label>
        <input type="date" id="dateCreated" name="dateCreated" class="formulaire-ajouter__input" required>
    </div>

    <div class="formulaire-ajouter__field">
        <label for="dimension" class="formulaire-ajouter__label">Dimension:</label>
        <input type="text" id="dimension" name="dimension" class="formulaire-ajouter__input" required>
    </div>

    <div class="formulaire-ajouter__field">
        <label for="condition_idCondition" class="formulaire-ajouter__label">Condition du timbre:</label>
        <select id="condition_idCondition" name="condition_idCondition" class="formulaire-ajouter__select" required>
    ...
    <div class="formulaire-ajouter__field">
        ...
        <select id="contry_idContry" name="contry_idContry" class="formulaire-ajouter__select" required>
    ...
    <div class="formulaire-ajouter__field">
        ...
        <select id="color_idColor" name="color_idColor" class="formulaire-ajouter__select" required>
            {% for color in colors %}
    ...
    <div class="formulaire-ajouter__field">
        ...
        <textarea id="draw" name="draw" class="formulaire-ajouter__textarea" rows="4" required></textarea>
    </div>
